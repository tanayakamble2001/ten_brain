...
urlpatterns = [
    ...
    path('blog_view2', views.blog_view2),
    path('blog_view6', views.blog_view6),
    path('blog_view7', views.blog_view7),
    path('blog_view8', views.blog_view8),
    path('blog_view9', views.blog_view9),
